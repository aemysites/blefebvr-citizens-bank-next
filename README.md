...
## Environments
- Preview: https://main--blefebvr-citizens-bank-next--aemysites.aem.page/
- Live: https://main--blefebvr-citizens-bank-next--aemysites.aem.live/
- Block Library: https://main--blefebvr-citizens-bank-next--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `blefebvr-citizens-bank-next` directory in your favorite IDE and start coding :)
